    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          <div className="text-gray-900 text-xl mb-2">Loading analytics...</div>
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Deep behavioral analysis and threat intelligence metrics across all operational nodes.</p>
        </div>
        
        {/* Date Range Filters */}
        <div className="flex items-center space-x-2 bg-white/60 backdrop-blur-sm border border-gray-200 rounded-2xl p-2">
          {['7D', '30D', '1Y'].map((range) => (
            <button
              key={range}
          ...
          <button className="px-4 py-2 text-gray-500 hover:text-gray-900 rounded-xl text-sm font-medium border border-gray-300 hover:border-gray-600/50 transition-all duration-200">
            Custom Range
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-xl font-semibold text-gray-900">Threat Vector Analysis</h3>
              <p className="text-gray-500 text-sm">Fraud Over Time</p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-blue-400 rounded-full"></div>
                <span className="text-gray-500 text-sm">Detected Incidents</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-xl font-semibold text-gray-900">Traffic Integrity</h3>
              <p className="text-gray-500 text-sm">Fraud Rate</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center mb-6">
            <div className="relative w-40 h-40">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-2xl font-bold text-gray-900">{fraudVsLegit.safe}%</div>
                  <div className="text-xs text-gray-500 uppercase tracking-wider">Safe Traffic</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600 text-sm">Validated Transactions</span>
              </div>
              <span className="text-gray-900 font-medium">{fraudVsLegit.safeCount.toLocaleString()}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-red-400 rounded-full"></div>
                <span className="text-gray-600 text-sm">Flagged Anomalies</span>
              </div>
              <span className="text-gray-900 font-medium">{fraudVsLegit.fraudCount}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-xl font-semibold text-gray-900">Volume Segmentation</h3>
              <p className="text-gray-500 text-sm">Amount Distribution</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {transactionDistribution.map((item, index) => (
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600 text-sm font-medium">{item.range}</span>
                  <div className="flex items-center space-x-2">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-xl font-semibold text-gray-900">Threat Categorization</h3>
              <p className="text-gray-500 text-sm">Risk Level Exposure</p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white/30 rounded-xl p-4 text-center">
              ...
              <div className="text-gray-500 text-xs uppercase tracking-wider">Low Risk</div>
              <div className="text-green-400 text-xs">-2.4%</div>
            </div>
            <div className="bg-white/30 rounded-xl p-4 text-center">
              <div className="text-2xl font-bold text-yellow-400 mb-1">156</div>
              <div className="text-gray-500 text-xs uppercase tracking-wider">Medium</div>
      ...
      <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-gray-900">Recent High-Risk Hits</h3>
        ...
        <div className="overflow-hidden">
          {/* Header */}
          <div className="grid grid-cols-5 gap-4 mb-4 pb-3 border-b border-gray-200">
            <div className="text-gray-500 text-xs font-medium uppercase tracking-wider">Incident ID</div>
            <div className="text-gray-500 text-xs font-medium uppercase tracking-wider">Time</div>
            <div className="text-gray-500 text-xs font-medium uppercase tracking-wider">Merchant</div>
            <div className="text-gray-500 text-xs font-medium uppercase tracking-wider">Amount</div>
            <div className="text-gray-500 text-xs font-medium uppercase tracking-wider">Risk Score</div>
          </div>
            ...
            {recentHighRisk.length > 0 ? (
              recentHighRisk.map((txn, index) => {
                ...
                return (
                  <div 
                    key={txn.id} 
                    className={`grid grid-cols-5 gap-4 items-center p-3 bg-gray-50 rounded-xl hover:bg-white/40 transition-all duration-300 delay-${index * 100} ${
                  ...
                  >
                    ...
                    <div className="text-gray-600 text-sm">{timeStr}</div>
                    <div className="text-gray-900 text-sm font-medium">{txn.merchant_name || 'Unknown'}</div>
                    <div className="text-cyan-400 font-bold text-sm">₹{txn.amount.toFixed(2)}</div>
                    <div className="flex items-center space-x-2">
                      <div className="w-12 bg-white rounded-full h-2">
                        <div
