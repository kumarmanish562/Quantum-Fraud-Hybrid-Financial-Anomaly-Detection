...
const TopNavbar = ({ title = "Dashboard", notificationCount = 0, userName = "Admin User", userRole = "Security Analyst", onMenuClick }) => {
  ...
  const showToast = (title, message, bgColor) => {
    ...
    toast.className = `fixed top-20 right-6 ${bgColor} text-gray-900 px-6 py-4 rounded-xl shadow-2xl z-50 animate-slide-in-right max-w-md`;
    toast.innerHTML = `
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="relative hidden md:block">
            <input
              ...
              className="bg-gray-100 border border-gray-300 rounded-xl px-4 py-2 pl-10 text-gray-600 placeholder-gray-500 focus:outline-none focus:border-blue-500/50 focus:bg-white/80 transition-all duration-200 w-64"
            />
          ...
          <div className="relative" ref={notificationRef}>
            <button 
              ...
              className="relative p-2 text-gray-500 hover:text-gray-900 transition-colors duration-200 hover:bg-gray-100 rounded-xl"
            >
            ...
            {isNotificationOpen && (
              <div className="absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-2xl shadow-xl z-50 backdrop-blur-sm">
                ...
                <div className="max-h-64 overflow-y-auto">
                  {isLoadingNotifications ? (
                    ...
                    notifications.map((notification) => (
                      <div key={notification.id} className="p-4 border-b border-gray-200/30 hover:bg-white/30 transition-colors duration-200 cursor-pointer">
          ...
          <div className="relative" ref={profileRef}>
            <button 
              ...
              className="flex items-center space-x-3 hover:bg-gray-100 rounded-xl p-2 transition-colors duration-200"
            >
              <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-full flex items-center justify-center shadow-lg">
                <span className="text-gray-900 text-sm font-bold">{userName.charAt(0)}</span>
              </div>
            ...
            {/* Profile Dropdown */}
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-2xl shadow-xl z-50 backdrop-blur-sm">
                {/* Profile Header */}
                <div className="p-4 border-b border-gray-200">
                  <div className="flex items-center space-x-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-full flex items-center justify-center">
                      <span className="text-gray-900 font-bold">{userName.charAt(0)}</span>
                    </div>
                    <div>
                ...
                <div className="py-2">
                  <button 
                    ...
                    className="w-full flex items-center space-x-3 px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors duration-200"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
